      ...
      <header className="border-b flex items-center justify-between rounded-bl-lg rounded-br-lg p-0 mx-4">
        ...
        <Menu anchorEl={anchorEl} open={open} onClose={handleMenuClose}>
          ...
          <MenuItem onClick={handleSignOut} sx={{ color: "red" }}>
            <div className="w-6 h-6 flex items-center justify-center rounded-full border border-gray-400 cursor-pointer hover:bg-gray-100 transition">
              <LogOut className="w-4 h-4 text-gray-600 color-" />
            </div>
            Logout
          </MenuItem>
        </Menu>
