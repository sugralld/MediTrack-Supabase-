      ...
      <header className="border-b flex items-center justify-between rounded-bl-lg rounded-br-lg p-0 mx-4">
        ...
        <Menu anchorEl={anchorEl} open={open} onClose={handleMenuClose}>
          <MenuItem disabled sx={{ color: "black" }}>
            <div className="w-6 h-6 flex items-center justify-center rounded-full border border-gray-500 mr-2">
              <User className="w-5 h-5 text-gray-600" />
            </div>
            {role || "Memuat..."}
          </MenuItem>
          <MenuItem onClick={handleSignOut} sx={{ color: "red" }}>
            <div className="w-6 h-6 flex items-center justify-center rounded-full border border-gray-400 cursor-pointer hover:bg-gray-100 transition mr-2">
              <LogOut className="w-4 h-4 text-gray-600 text-gray-950" />
            </div>
            Logout
          </MenuItem>
        </Menu>
