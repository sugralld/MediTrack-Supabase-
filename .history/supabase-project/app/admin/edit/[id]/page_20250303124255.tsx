...
const EditPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Update berhasil, redirect ke dashboard...");
  ...
  const handleDelete = async () => {
    try {
      ...
      setOpen(false); // Tutup modal setelah delete sukses
  ...
  return (
    <div>
      ...
      <Dialog open={open} onClose={handleClose}>
        <DialogTitle className="font-bold">Konfirmasi Penghapusan</DialogTitle>
      ...
      <Snackbar
        open={openSnackbar}
        autoHideDuration={3000} // ⏳ Tampilkan selama 3 detik
