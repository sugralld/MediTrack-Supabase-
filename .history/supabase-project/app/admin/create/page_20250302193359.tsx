...
const CreatePage = () => {
  ...
  const FileUpload = ({ handleFileChange }: { handleFileChange: (e: React.ChangeEvent<HTMLInputElement>) => void }) => {
      ...
      <form onSubmit={handleSubmit} className="flex gap-3 flex-col">
        ...
        <div>
          ...
          <Button
            variant="contained"
            color="primary"
            onClick={() => fileInputRef.current?.click()} // Klik button = klik input file
            sx={{
              textTransform: "none",
              borderRadius: "8px",
              padding: "10px 20px",
